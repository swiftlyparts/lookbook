...
var root = MOUNT;
  ...
  function card(d, idx){
    ...
    function reveal(){ img.classList.add("sgd-in"); b.style.aspectRatio = ""; }
    img.addEventListener("load", reveal);
    // a cached image can already be complete before this listener attaches,
  ...
  // Squarespace wraps the code block in ancestors that create a stacking context,
  // which pins a position:fixed child below the site header no matter its z-index.
  // Moving the overlay to <body> is the only reliable escape.
